...
var useDelayedFunction = _interopDefault(require('use-delayed-function'));
...
function AutoScrollContainer(_ref) {
  ...
  var contentDiv = React.useRef();
  var rightMarginDiv = React.useRef();
  var currentFocus = React.useRef(null);
  var childObserver = React.useRef(null);
  var mobileKeyboard = React.useRef(false);
  var justFocused = React.useRef(false);
  var prevViewMargin = React.useRef();
